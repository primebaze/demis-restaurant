...
const COURSES = [
  ...
  },
  {
    ...
    label: "Main Meal",
    title: "Jollof Rice",
    items: ["Perfectly spiced jollof rice", "Grilled chicken"],
    note: "Served with choice of protein",
    fixed: true,
  },
  {
    number: "04",
    label: "Dessert",
    title: "Ice Cream Xplosion",
    items: ["Signature ice cream dessert"],
    note: null,
    fixed: true,
  },
];
